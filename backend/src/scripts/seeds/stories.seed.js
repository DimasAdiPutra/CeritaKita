...
const seedStories = async (users) => {
	const stories = [
		{
			...
			coverImage: {
				url: 'https://ik.imagekit.io/dimasadiputra/easter-island-1661655_1920.jpg',
				width: 1920,
				height: 1280,
				size: 245678,
				mimeType: 'image/jpeg',
      ...
      `,
...

		{
			...
			coverImage: {
				url: 'https://ik.imagekit.io/dimasadiputra/italy-2940134_1920.jpg',
				width: 1920,
				height: 1280,
				size: 231004,
				mimeType: 'image/jpeg',
      ...
      `,
...

		{
			...
			excerpt:
				'Penasaran dengan bagaimana cara film indie ditampilkan? Aku jelaskan semuanya.',
			author: users[2]._id,

			coverImage: {
				url: 'https://ik.imagekit.io/dimasadiputra/norway-7887613_1920.jpg',
				width: 1920,
				height: 1280,
				size: 219332,
				mimeType: 'image/jpeg',
	...
	console.log('✅ Stories berhasil di-seed (model terbaru)')
}
